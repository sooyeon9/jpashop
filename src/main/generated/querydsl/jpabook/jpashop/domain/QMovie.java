...
public class QMovie extends EntityPathBase<Movie> {
    ...
    private static final long serialVersionUID = 1367331149L;

    public static final QMovie movie = new QMovie("movie");

    public final jpabook.jpashop.domain.item.QItem _super = new jpabook.jpashop.domain.item.QItem(this);
